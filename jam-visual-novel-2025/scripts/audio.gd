...
const primeraQuedada = preload("res://assets/audio/musica/cap3/background-music-upbeat-2-374859.mp3")
const momentoMareo = preload("res://assets/audio/musica/cap3/soft-background-music-409193.mp3")
const desmayada = preload("res://assets/audio/musica/cap4/background-epic-piano-music-for-short-video-vlog-advertising-35-sec-185384.mp3")
const despuesMareo = preload("res://assets/audio/musica/cap4/ambient-uplifting-presentation-motivational-corporate-382042.mp3")
const aceptandoSentimientos = preload("res://assets/audio/musica/cap4/just-relax-11157.mp3")
const darCarta = preload("res://assets/audio/musica/cap5/relaxing-piano-music-272714.mp3")
const declaracionMateo = preload("res://assets/audio/musica/cap5/emotional-piano-music-256262.mp3")

const finalCanon = preload("res://assets/audio/musica/finales/canon/chill-upbeat-401943.mp3")
